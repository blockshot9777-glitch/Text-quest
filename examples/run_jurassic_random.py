...
# Булев переключатель, не шкала. False — никогда не идти к врагу и не
# брать еду при нём (осмысленный, не героический тест). True — подходить
# всегда. Смерть от голода при туше с тегом еды — предел стратегии, не
# баг take/food. Сменить значение — правка политики харнесса, не движка.
# Профиль «подходить, только если голод > X» — новый параметр рядом
# (например RISK_APPROACH_HOSTILE_HUNGER), не третье значение этой константы.
RISK_APPROACH_HOSTILE = False
